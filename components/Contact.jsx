                ...
                <div className='grid lg:grid-cols-5 gap-8'>
                    ...
                    <div className='col-span-3 lg:col-span-2 w-full h-full  shadow-xl shadow-gray-400 rounded-xl p-4'>
                        <div className='lg:p-4 h-full'>
                            <div>
                                <Image className='rounded-xl hover:scale-105 ease-in duration-300' src={ContactImg}
                                       alt='/'/>
                            </div>

                            <div>
                                <h2 className='p-2'>Name here</h2>
                        ...
                        <div className='p-4'>
                            <form>
                                ...
                                <div className='flex flex-col py-2'>
                                    ...
                                    <textarea className='border-2 border-lg p-3 border-gray-300' rows='10'/>
                                </div>
